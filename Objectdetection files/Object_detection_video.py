...
VIDEO_NAME = 'unseen2.mp4'

# Where you want your output file
FILE_OUTPUT = 'testout.avi'
    ...
    for i,b in enumerate(boxes[0]):
        ...
        if classes[0][i] == 1: #or classes[0][i] == 2:
          if scores[0][i] >= 0.5:
            ...
            cv2.putText(frame, '{}'.format(apx_distance), (int(mid_x*720),int(mid_y*480)), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255,255,255), 2)
